			...
			<div class="col-md-3 col-sm-6 col-xs-6">
				<div class="footer">
					...
					<div class="footer-logo">
						<a class="logo" href="#">
							<img src="frontend/img/rizkyr.jpg" alt="">
						</a>
					</div>
					<!-- /footer logo -->
			...
			<div class="col-md-3 col-sm-6 col-xs-6">
				<div class="footer">
					...
					<ul class="footer-social">
						<li><a href="https://www.facebook.com/rizky.ramadhan.718"><i class="fa fa-facebook"></i></a></li>
						<li><a href="#"><i class="fa fa-twitter"></i></a></li>
						<li><a href="https://www.instagram.com/_rykzir"><i class="fa fa-instagram"></i></a></li>
						<li><a href="https://wa.me/6281932353385"><i class="fa fa-whatsapp"></i></a></li>
					</ul>
					<!-- /footer social -->
				</div>
			</div>
